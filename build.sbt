  ...
  .settings(
    ...
    assembly / assemblyMergeStrategy := {
      case PathList("META-INF", "MANIFEST.MF") =>
        MergeStrategy.discard // Discard all MANIFEST.MF from dependencies
      case PathList("META-INF", xs @ _*) =>
        MergeStrategy.discard // Discard everything else in META-INF
      case x => MergeStrategy.first // Take the first occurrence of duplicated files
    }
  )
  .dependsOn(server)